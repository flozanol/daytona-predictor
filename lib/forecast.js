...
/**
 * Pronóstico 2.0 - Enfoque en Cierre (Probables y Apartados)
 * Fórmula: Reales + Apartados + (Probables * 0.75)
 */
export function calcularPronostico20(ventasReales, apartados, probables) {
    const pronostico = ventasReales + (apartados || 0) + ((probables || 0) * 0.75);
    return Math.round(pronostico);
}
