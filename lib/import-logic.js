            ...
            try {
                ...
                if (vNuevos > 0 || vSemis > 0 || leads > 0 || visitas > 0) {
                    recordsToInsert.push({
                        ...
                        leads_contactados: parseInt(contactados),
                        citas_agendadas: parseInt(citasAgendadas),
                        citas_efectivas: parseInt(citasEfectivas),
                        visitas_piso: parseInt(visitas),
                        pruebas_manejo: parseInt(pruebas),
                        solicitudes_financiera: parseInt(financiera),
                        avaluos: parseInt(avaluos)
                    });
                }
            } catch (e) { continue; }
        }
